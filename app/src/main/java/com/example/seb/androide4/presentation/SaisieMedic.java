...
public class SaisieMedic extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v == btAjouter) {
            ...
            if (this.idMedicament >= 0) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(SaisieMedic.this);
                builder.setTitle("Erreur")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(SaisieMedic.this, "Il faut saisir des données ", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .show();
            }
                ...
                public void onResponse(Call<Medicaments> call, Response<Medicaments> uneReponse) {
                    if (uneReponse.isSuccessful()) {
                        ...
                        if (uneReponse.body() != null) {
                            Toast.makeText(SaisieMedic.this, "Insertion réussie!", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(SaisieMedic.this, "Erreur d'appel!", Toast.LENGTH_LONG).show();
                        }
                    } else {
